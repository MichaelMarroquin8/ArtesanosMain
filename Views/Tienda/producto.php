			...
			<div class="col-md-6 col-lg-5 p-b-30">
				<div class="p-r-50 p-t-5 p-lr-0-lg">
					...
					<div class="flex-w flex-m p-l-100 p-t-40 respon7">
						...
						<a href="https://api.whatsapp.com/send?phone=<?= "57".$arrProducto['telefono'] ?>" target="_blank" class="fs-14 cl3 hov-cl1 trans-04 lh-10 p-lr-5 p-tb-2 m-r-8 tooltip100" data-tooltip="WhatsApp">
